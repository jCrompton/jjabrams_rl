...
class VAE:
    ...
    conv_t_kernel_sizes = [10, 10, 10, 10, 2]
    ...
    def train(self, game, data_dir='/Users/jamescrompton/PycharmProjects/sandbox/retro_contest_jjabrams/data/training_data/'):
        ...
        self.model.fit_generator(data_gen, steps_per_epoch=steps_per_epoch, epochs=self.epochs, shuffle=True, use_multiprocessing=True, workers=2)
